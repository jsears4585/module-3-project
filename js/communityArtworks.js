function printTitle(data) {
  ...
  data.forEach(function(artwork) {
    $('#communityArtworksList').append(`<div style="width: 20%; margin-bottom: 55px;" class="grid-item"><h3>${artwork.title}</h3><img style="max-width: 200px; border: 1px solid #cacaca" src='${artwork.image}' alt='${artwork.title}'></div>`)
    console.log(artwork)
  })
